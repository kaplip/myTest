...
- (void)viewDidLoad {
    ...
    NSURLRequest *request = [ NSURLRequest requestWithURL:[NSURL URLWithString:@"http://api.map.baidu.com/place/detail?uid=6736548eda6ea03bf33cba77&output=html&source=placeapi_v2"] cachePolicy:0 timeoutInterval:60];
