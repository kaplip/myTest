...
//     UICollectionViewLayoutAttributes *headerAttr =  _array[0];
//     CGFloat headerMaxY =CGRectGetMaxY(headerAttr.frame);
 ...
 /**
     ...
     106  */
- (void)computerIndexCellHeightWithWidthBlock:(CGFloat (^)(NSIndexPath *, CGFloat))block{
        if (self.block != block) {
             self.block = block;
            }
  }
...
//   {
//        attributes.frame = CGRectMake(0, 0, 320, 100);
//    }
//    return attributes;
//}
